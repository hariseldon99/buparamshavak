...
#SBATCH -J GSL_eigenrand          # Job Name
#SBATCH -o GSL_eigenrand.o%j      # Name of the output file (myMPI.oJobID)
#SBATCH --time=00:15:00           # put proper time of reservation here
#SBATCH -n 1              # 1 tasks total
#SBATCH -e GSL_eigenrand.err%j    # Direct error to the error file

readonly RUNEXEC="./gsl_eigenrand"
