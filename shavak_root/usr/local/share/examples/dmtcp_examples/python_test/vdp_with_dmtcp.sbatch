...
#SBATCH -o VDP.o%j      # Name of the output file (myMPI.oJobID)
#SBATCH -n 5                  # Number of tasks
#SBATCH --time=00:15:00           # put proper time of reservation here
#SBATCH -e VDP.err%j    # Direct error to the error file

readonly RUNEXEC="./vdp_pool.py"
...
################################################################################
dmtcp_launch python3 $RUNEXEC ${SLURM_NTASKS}
