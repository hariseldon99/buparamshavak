...
#SBATCH -J matmulOMP          # Job Name
#SBATCH -o matmulOMP.o%j      # Name of the output file (myMPI.oJobID)
#SBATCH -n 5                  # Number of tasks
#SBATCH --time=00:15:00           # put proper time of reservation here
#SBATCH -e matmulOMP.err%j    # Direct error to the error file

readonly RUNEXEC="./matmul_omp"
